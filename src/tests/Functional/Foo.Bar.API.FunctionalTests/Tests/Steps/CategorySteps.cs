...
using Foo.Bar.API.FunctionalTests.Builders;
using Foo.Bar.API.FunctionalTests.Configuration;
using Foo.Bar.API.FunctionalTests.Models;
using Foo.Bar.Tests.Api.Builders.Http;

namespace Foo.Bar.API.FunctionalTests.Tests.Steps
{
    /// <summary>
